...
(function (T, O) {
    ...
    O(n, "Core/Utilities.js", [n["Core/Globals.js"]], function (f) {
        ...
        var L = (function () {
            ...
            b.prototype.run = function (b, c, e) {
                ...
                b !== c || this.elem["forceAnimate:" + this.prop]
                    ? ((this.startTime = +new Date()), (this.start = b), (this.end = c), (this.unit = e), (this.now = this.start), (this.pos = 0), (w.elem = this.elem), (w.prop = this.prop), w() && 1 === f.timers.push(w) && g(h))
                    : (delete z.curAnim[this.prop], z.complete && 0 === Object.keys(z.curAnim).length && z.complete.call(this.elem));
            };
        ...
        var d = (f.css = function (b, c) {
            ...
            F = (f.normalizeTickInterval = function (b, c, e, d, z) {
                ...
                var g = b / e;
                c ||
                    ((c = z ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10]),
                    !1 === d &&
                        (1 === e
            ...
            W = (f.animObject = function (b) {
                return y(b) ? f.merge({ duration: 500, defer: 0 }, b) : { duration: b ? 500 : 0, defer: 0 };
            }),
        ...
        var Q = (f.offset = function (b) {
            ...
            fa = (f.stop = function (b, c) {
                for (var e = f.timers.length; e--; ) f.timers[e].elem !== b || (c && c !== f.timers[e].prop) || (f.timers[e].stopped = !0);
            }),
    ...
    O(n, "Core/Color.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function (f, a) {
        ...
        a = (function () {
            ...
            a.prototype.brighten = function (a) {
                ...
                else if (S(a) && 0 !== a) for (f = 0; 3 > f; f++) (H[f] += n(255 * a)), 0 > H[f] && (H[f] = 0), 255 < H[f] && (H[f] = 255);
                return this;
            };
        ...
        n = (function () {
            ...
            F.prototype.complexColor = function (e, c, b) {
                ...
                h(this.renderer, "complexColor", { args: arguments }, function () {
                    ...
                    if (g) {
                        ...
                        "radialGradient" === g && u && !I(k.gradientUnits) && ((m = k), (k = x(k, d.getRadialAttr(u, m), { gradientUnits: "userSpaceOnUse" })));
                        r(k, function (b, c) {
                            "id" !== c && Q.push(c, b);
                        });
                        r(B, function (b) {
            ...
            F.prototype.getBBox = function (e, c) {
                ...
                if (!b) {
                    ...
                    d.isSVG &&
                        ...
                        c && ((g = c * y), (b.width = Math.abs(d * Math.sin(g)) + Math.abs(e * Math.cos(g))), (b.height = Math.abs(d * Math.cos(g)) + Math.abs(e * Math.sin(g)))));
                    if (B && 0 < b.height) {
            ...
            F.prototype.setTextPath = function (e, c) {
                ...
                if (e && c && c.enabled) {
                    ...
                    if (h) for (e = b.getElementsByTagName("tspan"); e.length; ) e[0].setAttribute("y", 0), g(l.dx) && e[0].setAttribute("x", -l.dx), m.appendChild(e[0]);
            ...
            F.prototype.strokeSetter = function (e, c, b) {
                ...
                this.stroke && this["stroke-width"]
                    ? (F.prototype.fillSetter.call(this, this.stroke, "stroke", b), b.setAttribute("stroke-width", this["stroke-width"]), (this.hasStroke = !0))
                    : "stroke-width" === c && 0 === e && this.hasStroke
                    ? (b.removeAttribute("stroke"), (this.hasStroke = !1))
                    : this.renderer.styledMode && this["stroke-width"] && (b.setAttribute("stroke-width", this["stroke-width"]), (this.hasStroke = !0));
            };
    ...
    O(n, "Core/Renderer/SVG/SVGLabel.js", [n["Core/Renderer/SVG/SVGElement.js"], n["Core/Utilities.js"]], function (f, a) {
        ...
        return (function (a) {
            ...
            v.prototype.on = function (a, q) {
                ...
                if (p) {
                    var t = function (t) {
                        (("mouseenter" === a || "mouseleave" === a) && t.relatedTarget instanceof Element && (v.element.contains(t.relatedTarget) || p.element.contains(t.relatedTarget))) || q.call(v.element, t);
                    };
                    p.on(a, t);
                }
            ...
            v.prototype.updateBoxSize = function () {
                ...
                this.needsBox &&
                    (this.box ||
                        ...
                        a.addClass(("button" === this.className ? "" : "highcharts-label-box") + (this.className ? " highcharts-" + this.className + "-box" : "")),
                        a.add(this),
            ...
            v.prototype.updateTextPadding = function () {
                ...
                y(this.widthSetting) && this.bBox && ("center" === this.textAlign || "right" === this.textAlign) && (v += { center: 0.5, right: 1 }[this.textAlign] * (this.widthSetting - this.bBox.width));
    ...
    O(n, "Core/Renderer/SVG/SVGRenderer.js", [n["Core/Color.js"], n["Core/Globals.js"], n["Core/Renderer/SVG/SVGElement.js"], n["Core/Renderer/SVG/SVGLabel.js"], n["Core/Utilities.js"]], function (f, a, n, y, D) {
        ...
        var B = a.svg,
            ...
            e = (function () {
                ...
                c.prototype.getRadialAttr = function (b, c) {
                    return { cx: b[0] - b[2] / 2 + c.cx * b[2], cy: b[1] - b[2] / 2 + c.cy * b[2], r: c.r * b[2] };
                };
                    ...
                    if (J !== b.textCache) {
                        ...
                        k || Q || f || A || (-1 !== g.indexOf(" ") && (!F || K.test(g)))
                            ? (a && a.appendChild(c),
                              k
                                  ? ((g = e.styledMode
                                        ? g.replace(/<(b|strong)>/g, '<span class="highcharts-strong">').replace(/<(i|em)>/g, '<span class="highcharts-emphasized">')
                                      ...
                                      if ("" !== g || 1 === h.length) {
                                          ...
                                          if (" " !== g) {
                                              ...
                                              if (A) {
                                                  ...
                                                  a = v(m);
                                                  if (f)
                                                      r = e.truncate(b, m, g, void 0, 0, Math.max(0, A - parseInt(N || 12, 10)), function (b, c) {
                                                      ...
                                                      for (; Q.length; )
                                                          Q.length &&
                                                              !F &&
                                                              0 < t &&
                                                              ((m = x.createElementNS(M, "tspan")), C(m, { dy: a, x: p }), P && C(m, "style", P), m.appendChild(x.createTextNode(Q.join(" ").replace(/- /g, "-"))), c.appendChild(m)),
                    ...
                    if (P) {
                        ...
                        ["width", "height"].forEach(function (b) {
                            a[b + "Setter"] = function (b, c) {
                                ...
                                this[c] = b;
                                v(d) &&
                                    (h && "within" === h.backgroundSize && this.width && this.height && (d = Math.round(d * Math.min(this.width / this.imgwidth, this.height / this.imgheight))),
        ...
        e.prototype.symbols = {
            circle: function (c, b, e, d) {
                return this.arc(c + e / 2, b + d / 2, e / 2, d / 2, { start: 0.5 * Math.PI, end: 2.5 * Math.PI, open: !1 });
            },
            ...
            callout: function (c, b, e, d, g) {
                ...
                w && w > e
                    ...
                    : g && 0 > g && w > c + h && w < c + e - h && l.splice(1, 1, ["L", w - 6, b], ["L", w, b - 6], ["L", w + 6, b], ["L", e - k, b]);
                return l;
            },
        };
        a.SVGRenderer = e;
                ...
                if (this.added) {
                    ...
                    if ("SPAN" === p.tagName) {
                        ...
                        var r = this.textWidth && L(this.textWidth),
                            ...
                            f;
                        (f = r !== this.oldTextWidth) && !(f = r > this.oldTextWidth) && ((f = this.textPxLength) || (C(p, { width: "", whiteSpace: x || "nowrap" }), (f = p.offsetWidth)), (f = f > r));
                        f && (/[ \-]/.test(p.textContent || p.innerText) || "ellipsis" === p.style.textOverflow)
                            ? (C(p, { width: r + "px", display: "block", whiteSpace: x || "normal" }), (this.oldTextWidth = r), (this.hasBoxWidthChanged = !0))
        ...
        a = (function () {
            ...
            a.prototype.addLabel = function () {
                ...
                if ((B = M && M.list))
                    a.shortenLabel = function () {
                        for (N = 0; N < B.length; N++) if ((A.attr({ text: t.labelFormatter.call(C(a.formatCtx, { dateTimeLabelFormat: B[N] })) }), A.getBBox().width < t.getSlotWidth(a) - 2 * q(g.padding, 5))) return;
                        A.attr({ text: "" });
                    };
                m && t._addedPlotLB && a.moveLabel(f, g);
                D(A) || a.movedLabel
                    ? A && A.textStr !== f && !m && (!A.textWidth || (g.style && g.style.width) || A.styles.width || A.css({ width: null }), A.attr({ text: f }), (A.textPxLength = A.getBBox().width))
                    : ((a.label = A = a.createLabel({ x: 0, y: 0 }, f, g)), (a.rotation = 0));
            };
            ...
            a.prototype.renderGridLine = function (a, t, f) {
                ...
                h ||
                    ...
                    (this.gridLine = h = x
                        ...
                        .add(p.gridGroup)));
                if (h && (f = p.getPlotLinePath({ value: k + d, lineWidth: h.strokeWidth() * f, force: "pass", old: a }))) h[a || this.isNew ? "attr" : "animate"]({ d: f, opacity: t });
            };
            a.prototype.renderMark = function (a, t, f) {
                ...
                g &&
                    ...
                    d[x ? "attr" : "animate"]({ d: this.getMarkPath(r, a, g[0], d.strokeWidth() * f, p.horiz, h), opacity: t }));
            };
            a.prototype.renderLabel = function (a, f, I, u) {
                ...
                k &&
                    ...
                    (this.isFirst && !this.isLast && !q(l.showFirstLabel, 1)) || (this.isLast && !this.isFirst && !q(l.showLastLabel, 1)) ? (x = !1) : !h || g.step || g.rotation || f || 0 === I || this.handleOverflow(a),
                    d && u % d && (x = !1),
                    x && H(a.y) ? ((a.opacity = I), k[this.isNewLabel ? "attr" : "animate"](a), (this.isNewLabel = !1)) : (k.attr("y", -9999), (this.isNewLabel = !0)));
            };
    ...
    O(n, "Core/Time.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function (f, a) {
        ...
        a = (function () {
            ...
            a.prototype.resolveDTLFormat = function (a) {
                return G(a, !0) ? a : ((a = L(a)), { main: a[0], from: a[1], to: a[2] });
            };
    ...
    O(n, "Core/Axis/Axis.js", [n["Core/Color.js"], n["Core/Globals.js"], n["Core/Axis/Tick.js"], n["Core/Utilities.js"], n["Core/Options.js"]], function (f, a, n, y, D) {
        ...
        y = (function () {
            ...
            e.prototype.defaultLabelFormatter = function () {
                ...
                else if (a && 1e3 <= c) for (; a-- && "undefined" === typeof f; ) (e = Math.pow(k, a + 1)), c >= e && 0 === (10 * b) % e && null !== h[a] && 0 !== b && (f = x(b / e, -1) + h[a]);
                    ...
                    c.series.forEach(function (d) {
                        if (d.visible || !b.options.chart.ignoreHiddenSeries) {
                            ...
                            if (c.isXAxis) {
                                ...
                                ((d = d.applyExtremes()),
                                l(d.dataMin) && ((h = d.dataMin), (c.dataMin = Math.min(r(c.dataMin, h), h))),
                                l(d.dataMax) && ((a = d.dataMax), (c.dataMax = Math.max(r(c.dataMax, a), a))),
                                q(k) && (c.threshold = k),
            ...
            e.prototype.setTickInterval = function (c) {
                ...
                Q &&
                    q(b.dataMin) &&
                    ((A = A || 0),
                    !q(M) && b.min < A && b.dataMin >= A ? (b.min = b.options.minRange ? Math.min(A, b.max - b.minRange) : A) : !q(F) && b.max > A && b.dataMax <= A && (b.max = b.options.minRange ? Math.max(A, b.min + b.minRange) : A));
                b.tickInterval =
                    b.min === b.max || "undefined" === typeof b.min || "undefined" === typeof b.max
                        ...
                        : r(f, this.tickAmount ? (b.max - b.min) / Math.max(this.tickAmount - 1, 1) : void 0, B ? 1 : ((b.max - b.min) * p) / Math.max(b.len, p));
                h &&
                    !c &&
                    b.series.forEach(function (c) {
                ...
                b.dateTime || b.logarithmic || f || (b.tickInterval = d(b.tickInterval, void 0, u(b.tickInterval), r(k.allowDecimals, 0.5 > b.tickInterval || void 0 !== this.tickAmount), !!this.tickAmount));
            ...
            e.prototype.adjustTickAmount = function () {
                ...
                if (this.hasData()) {
                    if (k < d) {
                        for (a = this.min; e.length < d; ) e.length % 2 || a === h ? e.push(L(e[e.length - 1] + b)) : e.unshift(L(e[0] - b));
                        this.transA *= (k - 1) / (d - 1);
            ...
            e.prototype.setScale = function () {
                ...
                this.setAxisSize();
                (c = this.len !== this.oldAxisLength) || b || e || this.isLinked || this.forceRedraw || this.userMin !== this.oldUserMin || this.userMax !== this.oldUserMax || this.alignToOthers()
            ...
            e.prototype.zoom = function (c, b) {
                ...
                t(this, "zoom", c, function (b) {
                    var c = b.newMin,
                        k = b.newMax;
                    if (c !== e.min || k !== e.max)
                        e.allowZoomOutside || (q(d) && (c < h && (c = h), c > a && (c = a)), q(g) && (k < h && (k = h), k > a && (k = a))),
            ...
            e.prototype.getExtremes = function () {
                ...
                return { min: c ? L(c.lin2log(this.min)) : this.min, max: c ? L(c.lin2log(this.max)) : this.max, dataMin: this.dataMin, dataMax: this.dataMax, userMin: this.userMin, userMax: this.userMax };
            };
                ...
                if (this.autoRotation) p > m && p > x.h ? (r.rotation = this.labelRotation) : (this.labelRotation = 0);
                    ...
                    if (!f) {
                        ...
                        for (m = e.length; !a && m--; ) {
                            var t = e[m];
                            if ((t = d[t].label))
                                t.styles && "ellipsis" === t.styles.textOverflow ? t.css({ textOverflow: "clip" }) : t.textPxLength > l && t.css({ width: l + "px" }),
            ...
            e.prototype.addTitle = function (c) {
                ...
                this.axisTitle ||
                    ((h = k.textAlign) || (h = (e ? { low: "left", middle: "center", high: "right" } : { low: d ? "right" : "left", middle: "center", high: d ? "left" : "right" })[k.align]),
                    (this.axisTitle = b
            ...
            e.prototype.render = function () {
                        ...
                        B &&
                            k.forEach(function (d, g) {
                                ...
                                0 === g % 2 &&
                                    ...
                                    (q = d + A),
                                    (f[d].options = { from: e ? e.lin2log(q) : q, to: e ? e.lin2log(N) : N, color: B, className: "highcharts-alternate-grid" }),
                                    f[d].render(),
                                    (f[d].isActive = !0));
                            }),
                        c._addedPlotLB ||
                ...
                Q && (Q[Q.isPlaced ? "animate" : "attr"]({ d: this.getLinePath(Q.strokeWidth()) }), (Q.isPlaced = !0), Q[F ? "show" : "hide"](F));
                ...
                if (this.crosshair && !1 !== (q(b) || !d)) {
                    ...
                    k ||
                        ((this.cross = k = h.renderer
                            ...
                            .add()),
                        h.styledMode ||
                            (k.attr({ stroke: e.color || (d ? f.parse("#ccd6eb").setOpacity(0.25).get() : "#cccccc"), "stroke-width": r(e.width, 1) }).css({ "pointer-events": "none" }), e.dashStyle && k.attr({ dashstyle: e.dashStyle })));
                    k.show().attr({ d: a });
            ...
            C = (function () {
                ...
                a.prototype.getLogTickPositions = function (a, f, n, q) {
                    ...
                    if (0.5 <= a) (a = Math.round(a)), (t = v.getLinearTickPositions(a, f, n));
                        ...
                        p = Math.floor(f);
                        var I, u;
                        for (E = 0.3 < a ? [1, 2, 4] : 0.15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; p < n + 1 && !u; p++) {
                            var m = E.length;
                            for (I = 0; I < m && !u; I++) {
                        ...
                        (f = this.lin2log(f)),
                            ...
                            (a = G("auto" === a ? null : a, this.minorAutoInterval, ((p.tickPixelInterval / (q ? 5 : 1)) * (n - f)) / ((q ? E / v.tickPositions.length : E) || 1))),
                            (a = D(a, void 0, y(a))),
            ...
            a.compose = function (a) {
                ...
                n(a, "init", function (a) {
                    ...
                    "logarithmic" !== a.userOptions.type
                        ...
                        : (f || (f = this.logarithmic = new C(this)), this.log2lin !== f.log2lin && (f.log2lin = this.log2lin.bind(this)), this.lin2log !== f.lin2log && (f.lin2log = this.lin2log.bind(this)));
                });
        ...
        var y = n.arrayMax,
            ...
            K = (function () {
                ...
                f.prototype.render = function () {
                    ...
                    t.chart.styledMode ||
                        (r
                            ? ((B.stroke = M || "#999999"), (B["stroke-width"] = q(m.width, 1)), m.dashStyle && (B.dashstyle = m.dashStyle))
                            : x && ((B.fill = M || "#e6ebf5"), m.borderWidth && ((B.stroke = m.borderColor), (B["stroke-width"] = m.borderWidth))));
                    e.zIndex = R;
                    b += "-" + R;
                    ...
                    h && (G(h.text) || G(h.formatter)) && B && B.length && 0 < t.width && 0 < t.height && !B.isFlat
                        ? ((h = v({ align: I && x && "center", x: I ? !x && 4 : 10, verticalAlign: !I && x && "middle", y: I ? (x ? 16 : 10) : x ? 6 : -4, rotation: I && !x && 90 }, h)), this.renderLabel(h, B, x, R))
                        : l && l.hide();
                    return f;
                };
                f.prototype.renderLabel = function (a, f, q, u) {
                    ...
                    m ||
                        ((m = { align: a.textAlign || a.align, rotation: a.rotation, class: "highcharts-plot-" + (q ? "band" : "line") + "-label " + (a.className || "") }),
                        (m.zIndex = u),
                ...
                if (q && p) {
                    ...
                    for (a = 0; a < q.length; a += 2) {
                        ...
                        ("M" !== f[0] && "L" !== f[0]) ||
                            ...
                            ("M" !== g[0] && "L" !== g[0]) ||
                            ("M" !== d[0] && "L" !== d[0]) ||
                            (m && g[1] === f[1] ? ((g[1] += h), (d[1] += h)) : m || g[2] !== f[2] || ((g[2] += h), (d[2] += h)), u.push(["M", f[1], f[2]], ["L", k[1], k[2]], ["L", d[1], d[2]], ["L", g[1], g[2]], ["Z"]));
                        u.isFlat = l;
                    }
                }
                return u;
            ...
            m.prototype.getAnchor = function (h, a) {
                ...
                this.followPointer && a
                    ...
                    : (h.forEach(function (g) {
                      ...
                      (m /= h.length),
                      (t /= h.length),
                      (h = [d ? k.plotWidth - t : m, this.shared && !d && 1 < h.length && a ? a.chartY - l : d ? k.plotHeight - m : t]));
            ...
            m.prototype.getLabel = function () {
                ...
                if (!this.label) {
                    this.outside &&
                        ...
                        (this.renderer = g = new f.Renderer(t, 0, 0, null === (a = this.chart.options.chart) || void 0 === a ? void 0 : a.style, void 0, void 0, g.styledMode)));
                    this.split
                        ? (this.label = g.g(r))
                        : ((this.label = g.label("", 0, 0, m.shape || "callout", null, null, m.useHTML, null, r).attr({ padding: m.padding, r: m.borderRadius })),
                          d || this.label.attr({ fill: m.backgroundColor, "stroke-width": m.borderWidth }).css(m.style).css({ pointerEvents: p }).shadow(m.shadow));
                ...
                var g = this.chart,
                    ...
                    b = function (b) {
                        ...
                        return [b, h ? B : M, h ? a : l].concat(
                            p
                                ? [h ? e(a) : c(l), h ? t.left - d + e(k.plotX + g.plotLeft) : t.top - d + c(k.plotY + g.plotTop), 0, h ? B : M]
                                : [h ? a : l, h ? k.plotX + g.plotLeft : k.plotY + g.plotTop, h ? g.plotLeft : g.plotTop, h ? g.plotLeft + g.plotWidth : g.plotTop + g.plotHeight]
                        );
                    },
                    z = b("y"),
                    w = b("x"),
                    ...
                    !1 === k
                        ...
                        : (this.split
                              ...
                              : ((h = this.getLabel()),
                                ...
                                h.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + E(d.colorIndex, A.colorIndex)),
                                t || h.attr({ stroke: g.borderColor || d.color || A.color || "#666666" }),
                                this.updatePosition({ plotX: l, plotY: M, negative: d.negative, ttBelow: d.ttBelow, h: B[2] || 0 })),
                    ...
                    if (!1 !== d && "" !== d) {
                        ...
                        "number" === typeof u
                            ? ((x = x.height + 1),
                              ...
                              e.push({ align: v ? 0 : void 0, anchorX: B, anchorY: u, boxWidth: f, point: a, rank: E(A.rank, h ? 1 : 0), size: x, target: A.y, tt: d, x: A.x }))
                            : (d.isActive = !1);
                    }
                    return e;
                }, []);
            ...
            m.prototype.drawTracker = function () {
                if (this.followPointer || !this.options.stickOnContact) this.tracker && this.tracker.destroy();
                    ...
                    if (l && k) {
                        ...
                        this.tracker ? this.tracker.attr(g) : ((this.tracker = l.renderer.rect(g).addClass("highcharts-tracker").add(l)), a.styledMode || this.tracker.attr({ fill: "rgba(0,0,0,0)" }));
                    }
                }
            };
        ...
        f = (function () {
            ...
            l.prototype.getCoordinates = function (a) {
                ...
                this.chart.axes.forEach(function (d) {
                    g[d.isXAxis ? "xAxis" : "yAxis"].push({ axis: d, value: d.toValue(a[d.horiz ? "chartX" : "chartY"]) });
                });
                return g;
            };
            ...
            l.prototype.pinch = function (a) {
                ...
                "touchstart" === a.type
                    ...
                    : h.length && (t || (g.selectionMarker = t = q({ destroy: C, touch: !0 }, d.plotBox)), g.pinchTranslate(h, k, u, t, e, f), (g.hasPinched = p), g.scaleGroups(u, e), g.res && ((g.res = !1), this.reset(!1, 0)));
            };
            ...
            l.prototype.setDOMEvents = function () {
                ...
                a.hasTouch &&
                    ...
                    a.unbindDocumentTouchEnd || (a.unbindDocumentTouchEnd = J(g, "touchend", this.onDocumentTouchEnd.bind(this))));
            };
    ...
    O(n, "Core/MSPointer.js", [n["Core/Globals.js"], n["Core/Pointer.js"], n["Core/Utilities.js"]], function (f, a, n) {
        ...
        function D(a, p, u, m) {
            ("touch" !== a.pointerType && a.pointerType !== a.MSPOINTER_TYPE_TOUCH) || !C[f.hoverChartIndex] || (m(a), (m = C[f.hoverChartIndex].pointer), m[p]({ type: u, target: a.currentTarget, preventDefault: H, touches: y() }));
        }
        var G =
                (this && this.__extends) ||
                (function () {
        ...
        var u = f.isFirefox,
            ...
            l = (function () {
                ...
                a.prototype.renderTitle = function () {
                    ...
                    h.text &&
                        (this.title ||
                            ((this.title = this.chart.renderer.label(h.text, d - 3, d - 4, null, null, null, a.useHTML, null, "legend-title").attr({ zIndex: 1 })),
                ...
                a.prototype.renderItem = function (a) {
                    ...
                    e ||
                        ((a.legendGroup = g
                            .g("legend-item")
                            .addClass("highcharts-" + b.type + "-series highcharts-color-" + a.colorIndex + (u ? " " + u : "") + (c ? " highcharts-series-" + a.index : ""))
                            .attr({ zIndex: 1 })
                        ...
                        this.baseline || ((this.fontMetrics = g.fontMetrics(d.styledMode ? 12 : l.fontSize, e)), (this.baseline = this.fontMetrics.f + 3 + this.itemMarginTop), e.attr("y", this.baseline)),
                ...
                a.prototype.proximatePositions = function () {
                    ...
                    this.allItems.forEach(function (g) {
                        ...
                        if (g.yAxis) {
                            ...
                            g.points &&
                                (k = J(l ? g.points : g.points.slice(0).reverse(), function (d) {
                                    return L(d.plotY);
                                }));
                ...
                a.prototype.align = function (a) {
                    ...
                    h !== a.y && (a = q(a, { y: h }));
                    this.group.align(q(g, { width: this.legendWidth, height: this.legendHeight, verticalAlign: this.proximate ? "top" : g.verticalAlign }), !0, a);
                };
                a.prototype.handleOverflow = function (a) {
                    var d = this,
                        g = this.chart,
                    ...
                    w.length = 0;
                    a > l && !1 !== e.enabled
                        ? ((this.clipHeight = p = Math.max(l - 20 - this.titleHeight - f, 0)),
                          ...
                          t || ((t = d.clipRect = h.clipRect(0, f, 9999, 0)), d.contentGroup.clip(t)),
                          n(p),
                          z ||
                ...
                a.prototype.scroll = function (a, d) {
                    ...
                    0 < f &&
                        ...
                        [this.up, this.upTracker].forEach(function (e) {
                            e.attr({ class: 1 === f ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" });
                        }),
                        t.attr({ text: f + "/" + l }),
                        [this.down, this.downTracker].forEach(function (e) {
                            e.attr({ x: 18 + this.pager.getBBox().width, class: f === l ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" });
                        }, this),
                        h.styledMode ||
    ...
    O(n, "Core/Chart/Chart.js", [n["Core/Axis/Axis.js"], n["Core/Globals.js"], n["Core/Legend.js"], n["Core/MSPointer.js"], n["Core/Options.js"], n["Core/Pointer.js"], n["Core/Time.js"], n["Core/Utilities.js"]], function (
        f,
        a,
        n,
        y,
        ...
        var H = a.charts,
            ...
            Y = (function () {
                ...
                D.prototype.temporaryDisplay = function (b) {
                    var c = this.renderTo;
                    if (b) for (; c && c.style; ) c.hcOrigStyle && (m(c, c.hcOrigStyle), delete c.hcOrigStyle), c.hcOrigDetached && (v.body.removeChild(c), (c.hcOrigDetached = !1)), (c = c.parentNode);
                    else
                        for (; c && c.style; ) {
                ...
                D.prototype.getContainer = function () {
                    ...
                    this.styledMode ||
                        (k = d(
                            { position: "relative", overflow: "hidden", width: f + "px", height: p + "px", textAlign: "left", lineHeight: "normal", zIndex: 0, "-webkit-tap-highlight-color": "rgba(0,0,0,0)", userSelect: "none" },
                            c.style
                        ));
                ...
                D.prototype.drawChartBox = function () {
                    ...
                    g[F](x);
                    k || (g.attr({ fill: m || "none" }).shadow(b.plotShadow), p && (f ? (p !== f.attr("href") && f.attr("href", p), f.animate(x)) : (this.plotBGImage = c.image(p, z, t, B, q).add())));
                ...
                D.prototype.linkSeries = function () {
                    ...
                    c.forEach(function (c) {
                        ...
                        F(e) &&
                            ...
                            e.linkedParent !== c &&
                            (e.linkedSeries.push(c), (c.linkedParent = e), e.enabledDataSorting && c.setDataSortingOptions(), (c.visible = z(c.options.visible, e.options.visible, c.visible)));
                    });
    ...
    O(n, "Extensions/ScrollablePlotArea.js", [n["Core/Chart/Chart.js"], n["Core/Globals.js"], n["Core/Utilities.js"]], function (f, a, n) {
        ...
        y(f, "afterSetChartSize", function (f) {
            ...
            if (!this.renderer.forExport) {
                if (v) {
                    ...
                    n &&
                        (this.scrollablePixelsY = v = Math.max(0, n - this.chartHeight)) &&
                        ((this.plotHeight += v), this.inverted ? ((this.clipBox.width += v), (this.plotBox.width += v)) : ((this.clipBox.height += v), (this.plotBox.height += v)), (C = { 2: { name: "bottom", value: v } }));
                C &&
                    !f.skipAxes &&
        ...
        f.prototype.applyFixed = function () {
            ...
            v
                ? ((this.fixedDiv = D("div", { className: "highcharts-fixed" }, { position: "absolute", overflow: "hidden", pointerEvents: "none", zIndex: 2, top: 0 }, null, !0)),
                  ...
                  (this.scrollableMask = f
                      .path()
                      .attr({ fill: this.options.chart.backgroundColor || "#fff", "fill-opacity": G(L.opacity, 0.85), zIndex: -1 })
            ...
            v = this.scrollablePixelsX
                ...
                ? [["M", L, 0], ["L", L, this.plotTop - 1], ["L", f, this.plotTop - 1], ["L", f, 0], ["Z"], ["M", L, K], ["L", L, this.chartHeight], ["L", f, this.chartHeight], ["L", f, K], ["Z"]]
                : [["M", 0, 0]];
        ...
        var a = f.addEvent,
            ...
            J = (function () {
                ...
                a.prototype.renderStackTotals = function () {
                    ...
                    var E = (this.stackTotalGroup = this.stackTotalGroup || q.g("stack-labels").attr({ visibility: "visible", zIndex: 6, opacity: 0 }).add());
        ...
        return (f.LegendSymbolMixin = {
            drawRectangle: function (a, f) {
                ...
                f.legendSymbol = this.chart.renderer
                    .rect(D ? (a.symbolWidth - n) / 2 : 0, a.baseline - n + 1, D ? n : a.symbolWidth, n, y(a.options.symbolRadius, n / 2))
            ...
            drawLineMarker: function (a) {
                ...
                C &&
                    ...
                    (this.legendSymbol = C = L.symbol(this.symbol, D / 2 - f, a - f, 2 * f, 2 * f, C)
                        .addClass("highcharts-point")
                        .add(q)),
                    (C.isMarker = !0));
            },
        ...
        a = (function () {
            ...
            a.prototype.optionsToObject = function (f) {
                ...
                if (L(f) || null === f) m[k[0]] = f;
                    ...
                    for (!l && f.length > g && ((h = typeof f[0]), "string" === h ? (m.name = f[0]) : "number" === h && (m.x = f[0]), d++); p < g; )
            ...
            a.prototype.resolveColor = function () {
                ...
                a.options.colorByPoint
                    ? (h || ((f = a.options.colors || a.chart.options.colors), (this.color = this.color || f[a.colorCounter]), (f = f.length)), (h = a.colorCounter), a.colorCounter++, a.colorCounter === f && (a.colorCounter = 0))
                    : (h = a.colorIndex);
        ...
        f.Series = n(
            ...
            },
            {
                ...
                init: function (e, c) {
                    ...
                    b.linkedSeries = [];
                    b.bindAxes();
                    I(b, { name: c.name, state: "", visible: !1 !== c.visible, selected: !0 === c.selected });
                    var g = c.events;
                    r(g, function (c, e) {
                ...
                autoIncrement: function () {
                    ...
                    a &&
                        ((e = new d.Date(c)),
                        "day" === a ? d.set("Date", e, d.get("Date", e) + b) : "month" === a ? d.set("Month", e, d.get("Month", e) + b) : "year" === a && d.set("FullYear", e, d.get("FullYear", e) + b),
                        (b = e.getTime() - c));
                    this.xIncrement = c + b;
                    return c;
                },
                ...
                setOptions: function (e) {
                    ...
                    (!d.negativeColor && !d.negativeFillColor) ||
                        d.zones ||
                        ((a = { value: d[this.zoneAxis + "Threshold"] || d.threshold || 0, className: "highcharts-negative" }), c || ((a.color = d.negativeColor), (a.fillColor = d.negativeFillColor)), b.push(a));
                    ...
                    e.forEach(function (c, e) {
                        ...
                        if (k.id || g(w)) {
                            if (
                                ...
                                -1 === w || "undefined" === typeof w ? h.push(c) : d[w] && c !== b.data[w] ? (d[w].update(c, !1, null, !1), (d[w].touched = !0), m && (l = w + 1)) : d[w] && (d[w].touched = !0),
                                !p || e !== w || (a && a.enabled) || this.hasDerivedData)
                            )
                                f = !0;
                        } else h.push(c);
                    }, this);
                    if (f) for (e = d.length; e--; ) (k = d[e]) && !k.touched && k.remove && k.remove(!1, c);
                    else
                        !p || (a && a.enabled)
                            ? (r = !1)
                            : (e.forEach(function (b, c) {
                ...
                setData: function (e, c, b, a) {
                    ...
                    if (!I) {
                        ...
                        if (z && m > z)
                            if (((z = h.getFirstValidPoint(e)), g(z))) for (b = 0; b < m; b++) (q[b] = this.autoIncrement()), (x[b] = e[b]);
                            else if (l(z))
                                if (F) for (b = 0; b < m; b++) (a = e[b]), (q[b] = a[0]), (x[b] = a.slice(1, F + 1));
                                else for (M && ((v = M.indexOf("x")), (u = M.indexOf("y")), (v = 0 <= v ? v : 0), (u = 0 <= u ? u : 1)), b = 0; b < m; b++) (a = e[b]), (q[b] = a[v]), (x[b] = a[u]);
                            else t(12, !1, r);
                        else for (b = 0; b < m; b++) "undefined" !== typeof e[b] && ((a = { series: h }), h.pointClass.prototype.applyOptions.apply(a, [e[b]]), h.updateParallelArrays(a, b));
                        x && d(x[0]) && t(14, !0, r);
                        h.data = [];
                ...
                cropData: function (e, c, b, a, d) {
                    ...
                    return { xData: e.slice(h, f), yData: c.slice(h, f), start: h, end: f };
                },
                generatePoints: function () {
                    ...
                    this.options.keys = e;
                    if (b && (f !== (a = b.length) || l)) for (r = 0; r < a; r++) r !== k || l || (r += f), b[r] && (b[r].destroyElements(), (b[r].plotX = void 0));
                    this.data = b;
                    this.points = p;
                ...
                getClipBox: function (e, c) {
                    ...
                    e && !1 === b.clip && h
                        ? (e = d ? { y: -a.chartWidth + h.len + h.pos, height: a.chartWidth, width: a.chartHeight, x: -a.chartHeight + g.len + g.pos } : { y: -h.pos, height: a.chartHeight, width: a.chartWidth, x: -g.pos })
                            ...
                            if (((f && "undefined" === typeof m.enabled) || m.enabled) && !k.isNull && !1 !== k.visible) {
                                ...
                                a
                                    ...
                                    : B &&
                                      ...
                                      ((k.graphic = a = c.renderer.symbol(r, t.x, t.y, t.width, t.height, p ? m : d).add(g)), this.enabledDataSorting && c.hasRendered && (a.attr({ x: k.startXPos }), (l = "animate")));
                ...
                drawGraph: function () {
                    ...
                    d.forEach(function (d, g) {
                        ...
                        f &&
                            !a &&
                            ((h = { stroke: d[2], "stroke-width": c.lineWidth, fill: (e.fillGraph && e.color) || "none" }),
                            d[3] ? (h.dashstyle = d[3]) : "square" !== c.linecap && (h["stroke-linecap"] = h["stroke-linejoin"] = "round"),
                ...
                invertGroups: function (a) {
                    function c() {
                        ["group", "markerGroup"].forEach(function (c) {
                            b[c] && (e.renderer.isVML && b[c].attr({ width: b.yAxis.len, height: b.xAxis.len }), (b[c].width = b.yAxis.len), (b[c].height = b.xAxis.len), b[c].invert(b.isRadialSeries ? !1 : a));
                        });
                    }
                    var b = this,
                        e = b.chart;
            ...
            K = (function () {
                ...
                a.prototype.render = function (a) {
                    ...
                    this.label
                        ...
                        : ((this.label = f.renderer.label(n, null, null, p.shape, null, null, p.useHTML, !1, "stack-labels")),
                          (n = { r: p.borderRadius || 0, text: n, rotation: p.rotation, padding: L(p.padding, 5), visibility: "hidden" }),
                          f.styledMode || ((n.fill = p.backgroundColor), (n.stroke = p.borderColor), (n["stroke-width"] = p.borderWidth), this.label.css(p.style)),
                          this.label.attr(n),
                ...
                a.prototype.setOffset = function (a, f, n, u, m) {
                    ...
                    f &&
                        ...
                        ((m = f.getBBox()),
                        (u = f.padding),
                        (k = "left" === k ? (l.inverted ? -u : u) : "right" === k ? m.width : l.inverted && "center" === k ? m.width / 2 : l.inverted ? (n ? m.width + u : -u) : m.width / 2),
                        ...
                        l.isInsidePlot(f.alignAttr.x + k - this.alignOptions.x, f.alignAttr.y + n - this.alignOptions.y) ? f.show() : ((f.alignAttr.y = -9999), (a = !1)),
        ...
        q.prototype.setStackedPoints = function (a) {
            ...
            if (f && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                ...
                for (B = 0; B < m; B++) {
                    ...
                    "percent" === f
                        ? ((v = v ? a : g), d && r[v] && r[v][M] ? ((v = r[v][M]), (c.total = v.total = Math.max(v.total, c.total) + Math.abs(E) || 0)) : (c.total = G(c.total + (Math.abs(E) || 0))))
                        : "group" === f
        ...
        q.prototype.modifyStacks = function () {
            ...
            a[m + "Stacker"] &&
                [f, "-" + f].forEach(function (h) {
                    for (var f = q.length, k, g; f--; ) if (((k = q[f]), (v = a.getStackIndicator(v, k, a.index, h)), (g = (k = n[h] && n[h][k]) && k.points[v.key]))) a[m + "Stacker"](g, k, f);
                });
        };
    ...
    O(n, "Core/Dynamics.js", [n["Core/Axis/Axis.js"], n["Core/Chart/Chart.js"], n["Core/Globals.js"], n["Core/Options.js"], n["Core/Series/Point.js"], n["Core/Time.js"], n["Core/Utilities.js"]], function (f, a, n, y, D, G, C) {
        ...
        t(a.prototype, {
            ...
            showLoading: function (a) {
                var g = this,
                    ...
                    e = h.loading,
                    c = function () {
                        f && q(f, { left: g.plotLeft + "px", top: g.plotTop + "px", width: g.plotWidth + "px", height: g.plotHeight + "px" });
                    };
                ...
                g.styledMode || (q(f, t(e.style, { zIndex: 10 })), q(g.loadingSpan, e.labelStyle), g.loadingShown || (q(f, { opacity: 0, display: "" }), v(f, { opacity: e.style.opacity || 0.5 }, { duration: e.showDuration || 0 })));
                g.loadingShown = !0;
                c();
            },
        ...
        a.prototype.collectionsWithInit = { xAxis: [a.prototype.addAxis, [!0]], yAxis: [a.prototype.addAxis, [!1]], series: [a.prototype.addSeries] };
        t(D.prototype, {
        ...
        t(y.prototype, {
            ...
            update: function (a, g) {
                ...
                a = k(e, x, { index: "undefined" === typeof e.index ? h.index : e.index, pointStart: d(e.pointStart, h.xData[0]) }, !l && { data: h.options.data }, a);
                ...
                if (l && this.points) {
                    ...
                    !1 === A.visible
                        ...
                        : h._hasPointLabels || ((a = A.marker), (e = A.dataLabels), a && (!1 === a.enabled || "symbol" in a) && (B.graphic = 1), e && !1 === e.enabled && (B.dataLabel = 1));
                                ...
                                f.push(p[a]),
                                    [-1, 1].forEach(function (d) {
                                        var f = 1 === d ? "rightNull" : "leftNull",
                                            q = 0,
                                            x = E[n[g + d]];
                                        if (x) for (h = t; 0 <= h && h < u; ) (k = x.points[h]), k || (h === t ? (p[a][f] = !0) : l[h] && (r = E[a].points[h]) && (q -= r[1] - r[0])), (h += m);
        ...
        a(
            ...
            },
            {
                ...
                drawPoints: function () {
                    ...
                    a.points.forEach(function (l) {
                        ...
                        if (v(l.plotY) && null !== l.y) {
                            ...
                            k || ((l.graphic = k = q[l.shapeType](h).add(l.group || a.group)) && a.enabledDataSorting && f.hasRendered && f.pointCount < m && (k.attr({ x: l.startXPos }), (g = !0), (d = "animate")));
                            if (k && g) k[d](L(h));
                ...
                animate: function (a) {
                    ...
                    if (a) (h.scaleY = 0.001), (a = C(p.toPixels(n.threshold), p.pos, p.pos + p.len)), m ? (h.translateX = a - p.len) : (h.translateY = a), f.clipBox && f.setClip(), f.group.attr(h);
                    else {
        ...
        p(
            ...
            },
            {
                ...
                updateTotals: function () {
                    ...
                    this.total = f;
                    for (a = 0; a < k; a++) (d = l[a]), (d.percentage = 0 < f && (d.visible || !g) ? (d.y / f) * 100 : 0), (d.total = f);
                },
                generatePoints: function () {
                    ...
                    if (0 === this.total && this.center) {
                        ...
                        this.graph ||
                            (this.graph = this.chart.renderer
                                ...
                                .add(this.group));
                        this.graph.attr({ d: a.prototype.symbols.arc(k, g, this.center[2] / 2, 0, { start: f, end: h, innerR: this.center[3] / 2 }) });
                ...
                redrawPoints: function () {
                    ...
                    a.points.forEach(function (h) {
                        ...
                        if (!h.isNull && g) {
                            ...
                            h.delayedRendering
                                ? (g.setRadialReference(a.center).attr(n).attr(k), f.styledMode || g.attr(d).attr({ "stroke-linejoin": "round" }).shadow(p, r), (h.delayedRendering = !1))
    ...
    O(n, "Core/Series/DataLabels.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function (f, a) {
            ...
            for (
                ...
                for (h = !1; d--; )
                    0 < d &&
                        ...
                        ((a[d - 1].size += a[d].size), (a[d - 1].targets = a[d - 1].targets.concat(a[d].targets)), (a[d - 1].align = 0.5), a[d - 1].pos + a[d - 1].size > l && (a[d - 1].pos = l - a[d - 1].size), a.splice(d, 1), (h = !0));
            }
            m.push.apply(m, n);
            d = 0;
            a.some(function (a) {
        ...
        m.prototype.drawDataLabels = function () {
            function a(a, d) {
                var c = d.filter;
                return c
                    ? ((d = c.operator), (a = a[c.property]), (c = c.value), (">" === d && a > c) || ("<" === d && a < c) || (">=" === d && a >= c) || ("<=" === d && a <= c) || ("==" === d && a == c) || ("===" === d && a === c) ? !0 : !1)
                    : !0;
            }
            function f(a, d) {
                var c = [],
                    ...
                    t.forEach(function (e, c) {
                        ...
                        if (b) {
                            ...
                            g.styledMode ||
                                ...
                                "contrast" === q.color ? ((h.contrastColor = y.getContrast(h.color || k.color)), (q.color = (!C(m) && e.inside) || 0 > m || d.stacking ? h.contrastColor : "#000000")) : delete h.contrastColor,
                        ...
                        !f || (b && C(r))
                            ? b &&
                              ...
                              (f
                                  ...
                                  : ((h.dataLabels = h.dataLabels || []),
                                    (f = h.dataLabels[c] = t ? y.text(r, 0, -9999, e.useHTML).addClass("highcharts-data-label") : y.label(r, 0, -9999, e.shape, null, null, e.useHTML, null, "data-label")),
                                    c || (h.dataLabel = f),
                                    f.addClass(" highcharts-data-label-color-" + h.colorIndex + " " + (e.className || "") + (e.useHTML ? " highcharts-tracker" : ""))),
                              (f.options = e),
                              f.attr(x),
                              g.styledMode || f.css(q).shadow(e.shadow),
                              f.added || f.add(D),
                              e.textPath && !e.useHTML && (f.setTextPath((h.getDataLabelPath && h.getDataLabelPath(f)) || h.graphic, e.textPath), h.dataLabelPath && !e.textPath.enabled && (h.dataLabelPath = h.dataLabelPath.destroy())),
                            ...
                            : ((h.dataLabel = h.dataLabel && h.dataLabel.destroy()),
                              ...
                              l && ((h.connector = h.connector.destroy()), h.connectors && (1 === h.connectors.length ? delete h.connectors : delete h.connectors[c])));
                    });
                });
            }
            ...
            if (z) {
                ...
                u
                    ? ((b = !1),
                      ...
                      (q = { x: g.x + (k.x || 0) + g.width / 2 + q.x, y: g.y + (k.y || 0) + { top: 0, middle: 0.5, bottom: 1 }[k.verticalAlign] * g.height }),
                      w(q),
                      f[d ? "attr" : "animate"](q).attr({ align: e }),
                      (w = (u + 720) % 360),
                      (w = 180 < w && 360 > w),
                      "left" === e ? (q.y -= w ? v.height : 0) : "center" === e ? ((q.x -= v.width / 2), (q.y -= v.height / 2)) : "right" === e && ((q.x -= v.width), (q.y -= w ? 0 : v.height)),
                      (f.placed = !0),
                      (f.alignAttr = q))
                ...
                if (k.shape && !u) f[d ? "attr" : "animate"]({ anchorX: m ? l.plotWidth - a.plotY : a.plotX, anchorY: m ? l.plotHeight - a.plotX : a.plotY });
            }
            d && n && (f.placed = !1);
        ...
        m.prototype.setDataLabelStartPos = function (a, f, k, g, d) {
            ...
            f.startXPos = m;
            f.startYPos = d;
            g ? "hidden" === f.visibility && (f.show(), f.attr({ opacity: 0 }).animate({ opacity: 1 })) : f.attr({ opacity: 1 }).animate({ opacity: 0 }, void 0, f.hide);
                        ...
                        if (m) {
                            ...
                            for (L = 0; L < m; L++) {
                                ...
                                p(d.crop, !0) &&
                                    ((z = b.getBBox().width),
                                    (u = null),
                                    G - z < n && 1 === l ? ((u = Math.round(z - G + n)), (O[3] = Math.max(u, O[3]))) : G + z > q - n && 0 === l && ((u = Math.round(G + z - q + n)), (O[1] = Math.max(u, O[1]))),
                                    0 > I - E / 2 ? (O[0] = Math.max(Math.round(-I + E / 2), O[0])) : I + E / 2 > t && (O[2] = Math.max(Math.round(I + E / 2 - t), O[2])),
                                    (b.sideOverflow = u));
                            }
                        }
                    }),
                            ...
                            if ((b = c.dataLabel) && b._pos && c.visible && 0 < c.labelDistance) {
                                ...
                                if ((e = !y))
                                    (c.connector = y = g.renderer
                                        .path()
                                        .addClass("highcharts-data-label-connector  highcharts-color-" + c.colorIndex + (c.className ? " " + c.className : ""))
                                        .add(a.dataLabelsGroup)),
                                        g.styledMode || y.attr({ "stroke-width": r, stroke: V.connectorColor || c.color || "#666666" });
                    ...
                    f &&
                        ...
                        ((h = f._pos)
                            ? (f.sideOverflow &&
                                  ...
                                  f.css({ width: f._attr.width + "px", textOverflow: (this.options.dataLabels.style || {}).textOverflow || "ellipsis" }),
                                  (f.shortened = !0)),
                              f.attr(f._attr),
        ...
        y.column &&
            (y.column.prototype.alignDataLabel = function (a, f, k, g, d) {
                ...
                n &&
                    ...
                    h && (g = { x: l.yAxis.len - g.y - g.height, y: l.xAxis.len - g.x - g.width, width: g.height, height: g.width }),
        ...
        f.prototype.hideOverlappingLabels = function (a) {
            ...
            var D = function (a) {
                ...
                if (a && (!a.alignAttr || a.placed)) {
                    ...
                    return { x: m.x + (n.translateX || 0) + h - (g || 0), y: m.y + (n.translateY || 0) + h - f, width: a.width - 2 * h, height: a.height - 2 * h };
                }
            };
                ...
                t
                    ...
                    : a.graph &&
                      ((a.tracker = p
                          ...
                          .add(a.group)),
                      m.styledMode || a.tracker.attr({ "stroke-linecap": "round", "stroke-linejoin": "round", stroke: c, fill: g ? c : "none", "stroke-width": a.graph.strokeWidth() + (g ? 0 : 2 * q) }),
                    ...
                    f.forEach(function (e) {
                        ...
                        c.isOrdinal ||
                            ...
                            c.series.length &&
                                ...
                                h >= p &&
                                r <= k &&
                                (c.setExtremes(h, r, !1, !1, { trigger: "pan" }), g.resetZoomButton || l || h === p || r === k || !n.match("y") || (g.showResetZoom(), (c.displayBtn = !1)), (m = !0)),
                            (g[b] = f));
                    });
                    m && g.redraw(!1);
                ...
                d.firePointEvent(a ? "select" : "unselect", { accumulate: f }, function () {
                    ...
                    f ||
                        k.getSelectedPoints().forEach(function (a) {
                            ...
                            a.selected &&
                                a !== d &&
                                ((a.selected = a.options.selected = !1), (f.options.data[f.data.indexOf(a)] = a.options), a.setState(k.hoverPoints && f.options.inactiveOtherPoints ? "inactive" : ""), a.firePointEvent("unselect"));
                        });
                });
                ...
                if (!((a === this.state && !f) || (this.selected && "select" !== a) || !1 === k.enabled || (a && (p || (m && !1 === n.enabled))) || (a && c.states && c.states[a] && !1 === c.states[a].enabled))) {
                    ...
                    a && a.size && e && "hidden" !== k && !this.isCluster
                        ? (t || (d.halo = t = b.renderer.path().add(e.parentGroup)),
                          ...
                          t.attr({ class: "highcharts-halo highcharts-color-" + h(this.colorIndex, d.colorIndex) + (this.className ? " " + this.className : ""), visibility: k, zIndex: -1 }),
                          (t.point = this),
        ...
        q(y.prototype, {
            ...
            setState: function (a, f) {
                ...
                if (
                    ...
                    if (k && !k.dashstyle) for (m = { "stroke-width": n }, k.animate(m, e); d["zone-graph-" + g]; ) d["zone-graph-" + g].attr(m), (g += 1);
                    l ||
    ...
    O(n, "Core/Responsive.js", [n["Core/Chart/Chart.js"], n["Core/Utilities.js"]], function (f, a) {
        ...
        f.prototype.setResponsive = function (a, f) {
            ...
            y !== (p && p.ruleIds) &&
                ...
                y ? ((p = this.currentOptions(f)), (p.isResponsiveOptions = !0), (this.currentResponsive = { ruleIds: y, mergedOptions: f, undoOptions: p }), this.update(f, a, !0)) : (this.currentResponsive = void 0));
        };
